...
1. You are using the latest Spark Desktop release.
2. Windows and Microsoft Edge WebView2 are up to date.
3. The same Gemini Spark / Google Workspace workflow works in a normal supported browser.
4. The issue is reproducible after restarting Spark Desktop.

## Good bug reports

Include:

- Spark Desktop version;
- Windows version;
